...
import ru.nikolas_snek.productlist.domain.use_case.AddShopItemUseCase
import ru.nikolas_snek.productlist.domain.use_case.EditShopItemUseCase
import ru.nikolas_snek.productlist.domain.use_case.GetShopItemUseCase
...
class ShopItemViewModel : ViewModel() {
    ...
    fun editShopItem(inputName: String?, inputCount: String?) {
        ...
        if (fieldsValid) {
            _shopItem.value?.let {
                val item = it.copy(product = name, count = count)
